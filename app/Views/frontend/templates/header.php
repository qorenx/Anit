...
`body` tag options:
  ...
  * sidebar-mini
-->
<body class="sidebar-mini layout-navbar-fixed sidebar-collapse layout-fixed dark-mode sidebar-closed layout-footer-fixed">
    <?php $uri = service('uri') ?>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i>Hours</p>
              </div>
            </div>
            <!-- Message End -->
          </a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">x Notifications</span>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i>x new messages
            <span class="float-right text-muted text-sm">x mins</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> x friend requests
            <span class="float-right text-muted text-sm">x hours</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> x new reports
            <span class="float-right text-muted text-sm">x days</span>
          </a>
          <div class="dropdown-divider"></div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Anitium</span>
    </a>
